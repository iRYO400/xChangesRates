...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (position) {
            case 0:
                optionView.bind(option, parent.getContext().getResources().getDrawable(R.drawable.ic_bar_chart), null);
                break;
            case 1:
                optionView.bind(option, parent.getContext().getResources().getDrawable(R.drawable.ic_pages_24dp), null);
                break;
            case 2:
                optionView.bind(option, parent.getContext().getResources().getDrawable(R.drawable.ic_settings_applications_24dp), null);
                break;
            case 3:
                optionView.bind(option, parent.getContext().getResources().getDrawable(R.drawable.ic_info_outline_24dp, null));
                break;
            default:
