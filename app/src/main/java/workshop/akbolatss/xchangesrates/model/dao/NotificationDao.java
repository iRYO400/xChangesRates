...
public class NotificationDao extends AbstractDao<Notification, Long> {
    ...
    private Query<Notification> chartData_NotificationListQuery;
    ...
    protected final void bindValues(DatabaseStatement stmt, Notification entity) {
        ...
        if (notificationId != null) {
            stmt.bindLong(6, notificationId);
        }
    }
    ...
    public Notification readEntity(Cursor cursor, int offset) {
        Notification entity = new Notification( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5) // notificationId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Notification entity, int offset) {
        ...
        entity.setNotificationId(cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5));
     }
    ...
    /** Internal query to resolve the "notificationList" to-many relationship of ChartData. */
    public List<Notification> _queryChartData_NotificationList(Long notificationId) {
        synchronized (this) {
            if (chartData_NotificationListQuery == null) {
                QueryBuilder<Notification> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.NotificationId.eq(null));
                chartData_NotificationListQuery = queryBuilder.build();
            }
        }
        Query<Notification> query = chartData_NotificationListQuery.forCurrentThread();
